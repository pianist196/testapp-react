			...
			<div className="filters">
				...
				<div className="filetrs__distance">
					...
					<div className="filters__distance-select">
						<select name="" id="" className="select">
							<option value="1" defaultValue>Меньше 1 км</option>
				...
				<div className="filters__housing">
					...
					<div className="filters__housing-checkbox">
						<div className="checkbox">
							<input className="checkbox__input" type="checkbox" id="checkbox_1" defaultChecked />
							<label className="checkbox__label" htmlFor="checkbox_1">Отель</label>
						</div>
						<div className="checkbox">
							<input className="checkbox__input" type="checkbox" id="checkbox_2" defaultChecked />
							<label className="checkbox__label" htmlFor="checkbox_2">Апартаменты</label>
						</div>
						<div className="checkbox">
							<input className="checkbox__input" type="checkbox" id="checkbox_3" defaultChecked />
				...
				<div className="filters__money">
					...
					<div className="filters__money-radio">
						<div className="radio">
							<input className="radio__input" type="radio" id="radio_2" name="male" defaultChecked />
							<label className="radio__label" htmlFor="radio_2">Рубли</label>
						</div>

						<div className="radio">
							<input className="radio__input" type="radio" id="radio_3" name="male" />
							<label className="radio__label" htmlFor="radio_3">Доллары США</label>
						</div>

						<div className="radio">
							<input className="radio__input" type="radio" id="radio_4" name="male" />
