        ...
        <div className="wrapper-filters" >
            <div className="filters">
                ...
                <div className="filters__price">
                    ...
                    <div className="filters__price-range" id="range-slider"></div>
                ...
                <div className="filetrs__distance">
                    ...
                    <div className="filters__distance-select">
                        <div className="custom-select" style={{ width: '200px' }}>
                            <select>
                                <option value="0">Меньше 1 км</option>
                                <option value="1">Меньше 2 км</option>
                                <option value="2">Меньше 5 км</option>
                                <option value="3">Меньше 10 км</option>
                            </select>
                        </div>
                    </div>
                </div>
